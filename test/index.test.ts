...
describe("XLF Main Index", () => {
	it("should throw error for invalid XLIFF (missing root)", () => {
		expect(() => parseXlf("<root></root>")).toThrow(
			"Invalid XLF: missing <xliff>",
		);
	});
	...
	it("should roundtrip version 2.0", () => {
		const xml =
			'<?xml version="1.0"?><xliff version="2.0" xmlns="urn:oasis:names:tc:xliff:document:2.0" srcLang="en"><file id="f1"><unit id="u1"><segment><source>S</source></segment></unit></file></xliff>';
